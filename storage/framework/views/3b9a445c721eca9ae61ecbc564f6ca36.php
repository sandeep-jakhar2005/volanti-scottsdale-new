...
<?php elseif(
    (isset($orderId) && request()->is('admin/paymentprofile/customers/orders/view/' . $orderId)) ||
        (isset($customerId) &&
            request()->is('CheckoutCustomOrders*') &&
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\VolantiJetCateringGit\packages\Webkul\MpAuthorizeNet\src\Providers/../Resources/views/shop/volantijetcatering/checkout/card-script.blade.php ENDPATH**/ ?>